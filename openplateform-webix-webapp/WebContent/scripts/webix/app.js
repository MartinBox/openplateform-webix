...
function(e) {
    ...
    function i(e, t) {
        ...
        if (e && "." === e.charAt(0)) if (t) {
            for (h = h.slice(0, h.length - 1), e = e.split("/"), o = e.length - 1, f.nodeIdCompat && y.test(e[o]) && (e[o] = e[o].replace(y, "")), e = h.concat(e), c = 0; c < e.length; c += 1) if (p = e[c], "." === p) e.splice(c, 1),
            c -= 1;
            else if (".." === p) {
        ...
        if ((h || g) && m) {
            for (i = e.split("/"), c = i.length; c > 0; c -= 1) {
                if (a = i.slice(0, c).join("/"), h) for (u = h.length; u > 0; u -= 1) if (n = m[h.slice(0, u).join("/")], n && (n = n[a])) {
                    r = n,
                    s = c;
                    break
                }
                if (r) break; ! l && g && g[a] && (l = g[a], d = c)
            } ! r && l && (r = l, s = d),
    ...
    u = function(e, t) {
        ...
        return e = r[1],
        l && (l = i(l, t), a = o(l)),
        l ? e = a && a.normalize ? a.normalize(e, n(t)) : i(e, t) : (e = i(e, t), r = s(e), l = r[0], e = r[1], l && (a = o(l))),
        {
            f: l ? l + "!" + e: e,
            n: e,
            pr: l,
    ...
    d = function(i, n, s, l) {
        ...
        if (l = l || i, "undefined" === x || "function" === x) {
            for (n = !n.length && s.length ? ["require", "exports", "module"] : n, w = 0; w < n.length; w += 1) if (v = u(n[w], l), c = v.f, "require" === c) b[w] = p.require(i);
            else if ("exports" === c) b[w] = p.exports(i),
            y = !0;
            else if ("module" === c) d = b[w] = p.module(i);
            else if (t(h, c) || t(m, c) || t(g, c)) b[w] = o(c);
            else {
                if (!v.p) throw new Error(i + " missing " + c);
                v.p.load(v.n, a(l, !0), r(c), {}),
                b[w] = h[c]
            }
            f = s ? s.apply(h[i], b) : void 0,
            i && (d && d.exports !== e && d.exports !== h[i] ? h[i] = d.exports: f === e && y || (h[i] = f))
        } else i && (h[i] = s)
    },
    requirejs = require = c = function(t, i, a, n, r) {
        ...
        return i = i ||
        function() {},
        "function" == typeof a && (a = n, n = r),
        n ? d(e, t, i, a) : setTimeout(function() {
            d(e, t, i, a)
        },
        4),
        c
    ...
    define = function(e, i, a) {
        i.splice || (a = i, i = []),
        t(h, e) || t(m, e) || (m[e] = [e, i, a])
    },
    define.amd = {
        jQuery: !0
    }
} (),
define("libs/almond.js",
function() {}),
function(e) {
    var t = [],
    i = {},
    ...
    r = function(e, t) {
        ...
        this.fns = [],
        this.params = {},
        this.regex = o(this.path, this.keys, !1, !1)
    };
    ...
    r.prototype.removeHandler = function(e) {
        for (var t = 0,
        i = this.fns.length; i > t; t++) {
            var a = this.fns[t];
            if (e == a) return this.fns.splice(t, 1),
            void 0
        }
    },
    r.prototype.run = function(e) {
        for (var t = 0,
        i = this.fns.length; i > t; t++) this.fns[t].apply(this, e)
    },
    ...
    var o = function(e, t, i, a) {
        return e instanceof RegExp ? e: (e instanceof Array && (e = "(" + e.join("|") + ")"), e = e.concat(a ? "": "/?").replace(/\/\(/g, "(?:/").replace(/\+/g, "__plus__").replace(/(\/)?(\.)?:(\w+)(?:(\(.*?\)))?(\?)?/g,
    ...
    s = function(e, a) {
        ...
        e = 2 == n.length ? n[1] : n[0],
        i[e] || (i[e] = new r(e, o), t.push(i[e])),
        i[e].addHandler(a)
    },
    l = function(e, t) {
...
function() {
    ...
    function a(e) {
        var t = [];
        for (var i in e) t.length && t.push(":"),
        t.push(i + "=" + e[i]);
        return t.join("")
    }
    function n(t, i, a) {
        if (d(w, t, i, a, this) !== !1) {
            ...
            return d(v, t, i, a, this),
            t.$onurlchange && t.$onurlchange.call(t, i.params, a, this) === !1 ? void 0 : this.$layout
        }
    }
    function r(e) {
        var t = e.split("/");
    ...
    function o(e, t, i) {
        if (e.$oninit && i._init.push(e.$oninit), e.$ondestroy && i._destroy.push(e.$ondestroy), e.$subview) if ("string" == typeof e.$subview) {
            {
        ...
        t = t || (webix.isArray(e) ? [] : {});
        for (var r in e) t[r] = e[r] && "object" == typeof e[r] && !webix.isDate(e[r]) ? o(e[r], webix.isArray(e[r]) ? [] : {},
        i) : e[r];
        return t
    }
    function s(e, t) {
    ...
    function l(e, t) {
        ...
        } else webix.ui.$freeze = !1,
        webix.ui.resize()
    }
    function d(e, t, i, a, n) {
        for (var r = 0; r < e.length; r++) if (e[r](t, i, a, n) === !1) return ! 1;
        return ! 0
    }
    function c(e, t, i) {
    ...
    function u(e, t) {
        ...
        return n.$scope = this,
        n.id && (i = $$(n.id)),
        i || (i = webix.ui(n, t), this._uis.push(i), p(a._init, i, this)),
        i
    }
    function p(e, t, i) {
        if (e) for (var a = 0; a < e.length; a++) e[a](t, i)
    }
    function h() {
        if (this._ui) {
            this.$layout && h.call(this.$layout);
            for (var e = this._handlers,
            t = e.length - 1; t >= 0; t--) e[t].obj.detachEvent(e[t].id);
            this._handlers = [];
            for (var i = this._uis,
            t = i.length - 1; t >= 0; t--) i[t] && i[t].destructor && i[t].destructor();
            this._uis = [],
            p(this._destroy, this._ui, this),
    ...
    function f(e) {
        this._uis = [],
        this._handlers = [],
        this.root && this.root.config && m(this.root),
        this._ui = webix.ui(e, this.root),
        this.parent && (this.root = this._ui),
        p(this._init, this._ui, this)
    }
    function g(e) {
    ...
    b = {
        create: function(e) {
            ...
            webix.extend(b, webix.EventSystem),
            setTimeout(function() {
            ...
            return webix.html.addCss(t, "webixappstart"),
            setTimeout(function() {
                webix.html.removeCss(t, "webixappstart"),
                webix.html.addCss(t, "webixapp")
            },
            10),
            b
        },
        ...
        start: function() {
            routie("!*", b.router),
            window.location.hash ? (webix.ui.$freeze = !1, webix.ui.resize()) : b.show(b.config.start)
        },
        use: function(e, t) {
            e.$oninit && e.$oninit(this, t || {}),
            e.$onurlchange && w.push(e.$onurlchange),
            e.$onurl && y.push(e.$onurl),
            e.$onui && v.push(e.$onui)
        },
        trigger: function(e) {
...
function(e) {
    ...
    function n(e, t, i) {
        var n, r, s;
        return null != i && e ? (r = e.split(c), s = r[o(t, i)] || r[0], n = a(s)) : n = e,
        n
    }
    function r(e) {
        var t = i(p);
    ...
    t.prototype.t = function(e, t) {
        ...
        return "" === a ? (this.warn('Missing translation for key: "' + e + '"'), i = e) : (t = d(t), i = n(a, this.currentLocale, t.smart_count), i = s(i, t)),
        i
    };
    var c = "||||",
    u = {
...
function() {
    function e(e, t) {
        ...
        void 0;
        if (a && a != e) return document.location.reload(),
        void 0;
        a = e;
        var i = a.settings && "string" == typeof a.settings;
        a.settings = i ? JSON.parse(a.settings) : {},
        webix.extend(a.settings, {
            language: "en",
            theme: "siberia:webix",
            notifications: 0
        }),
        require(["helpers/locale", "helpers/theme"],
        function(e, i) {
            t && (e.isNow(a.settings.language) && i.isNow(a.settings.theme) || document.location.reload()),
            e.setLang(a.settings.language, t),
            i.setTheme(a.settings.theme, t)
        })
    }
    function t() {
        return a
...
define("helpers/locale", ["libs/polyglot", "models/user"],
function(e, t) {
    function i() {
        return t.getCurrentUser() ? t.getCurrentUser().settings.language: webix.storage.local.get(o) || r
    }
    function a(e) {
        webix.storage.local.put(o, e),
        t.getCurrentUser() ? t.saveSetting("language", e, e != s) : document.location.reload()
    }
    function n(e) {
        s = e,
        define("locale", ["locales/" + e],
        function(t) {
            var i = new Polyglot({
                phrases: t
            });
...
define("helpers/theme", ["models/user"],
function(e) {
    function t() {
        return e.getCurrentUser() ? e.getCurrentUser().settings.theme: n
    }
    function i(t) {
        webix.storage.local.put(a, t),
        e.getCurrentUser() ? e.saveSetting("theme", t, t != n) : document.location.reload(),
        n = t
    }
    var a = "--:app:theme",
...
define("libs/rollbar", ["require", "exports", "module"],
function(require, exports, module) {
    ...
    function computeStackTraceWrapper(e) {
        ...
        function i(e) {
            if (!w.hasOwnProperty(e)) {
                var i = ""; - 1 !== e.indexOf(document.domain) && (i = t(e)),
                w[e] = i ? i.split("\n") : []
            }
            return w[e]
        }
        function a(e, t) {
            ...
            for (var d = 0; s > d; ++d) if (o = l[t - d] + o, !_isUndefined(o)) {
        ...
        function s(e, t) {
            for (var a, n, r = 0,
            o = t.length; o > r; ++r) if ((a = i(t[r])).length && (a = a.join("\n"), n = e.exec(a))) return {
                url: t[r],
        ...
        function l(e, t, a) {
            ...
            return a -= 1,
            o && o.length > a && (n = s.exec(o[a])) ? n.index: null
        }
        function d(e) {
            ...
            if (a = u.exec(c)) {
                ...
                t = r(a[3]).replace(/;$/, ";?"),
                i = new RegExp("function" + f + "\\s*\\(\\s*" + g + "\\s*\\)\\s*{\\s*" + t + "\\s*}")
            } else i = new RegExp(r(c).replace(/\s+/g, "\\s+"));
            if (n = s(i, l)) return n;
            if (a = p.exec(c)) {
                var v = a[1];
        ...
        function c(e) {
            ...
            for (var t, i, r = /^\s*at (?:((?:\[object object\])?\S+(?: \[as \S+\])?) )?\(?((?:file|http|https):.*?):(\d+)(?::(\d+))?\)?\s*$/i,
            ...
            s = e.stack.split("\n"), d = [], c = /^(.*) is undefined$/.exec(e.message), u = 0, p = s.length; p > u; ++u) {
                ...
                } ! i.func && i.line && (i.func = a(i.url, i.line)),
                i.line && (i.context = n(i.url, i.line)),
                d.push(i)
            }
            return d[0] && d[0].line && !d[0].column && c && (d[0].column = l(c[1], d[0].url, d[0].line)),
            d.length ? {
                mode: "stack",
                name: e.name,
                message: e.message,
        ...
        function u(e) {
            for (var t, i = e.stacktrace,
            r = / line (\d+), column (\d+) in (?:<anonymous function: ([^>]+)>|([^\)]+))\((.*)\) in (.*):\s*$/i,
            o = i.split("\n"), s = [], l = 0, d = o.length; d > l; l += 2) if (t = r.exec(o[l])) {
                var c = {
                    line: +t[1],
                    column: +t[2],
                    func: t[3] || t[4],
        ...
        function p(e) {
            ...
            for (l = 2, d = t.length; d > l; l += 2) {
                ...
                if (v) {
                    ...
                    v.context = C && $.replace(/^\s*/, "") === t[l + 1].replace(/^\s*/, "") ? C: [t[l + 1]],
                    m.push(v)
                }
            }
            return m.length ? {
        ...
        function h(e, t, i, r) {
            ...
            if (o.url && o.line) {
                e.incomplete = !1,
                o.func || (o.func = a(o.url, o.line)),
                o.context || (o.context = n(o.url, o.line));
                var s = / '([^']+)' /.exec(r);
        ...
        function m(e, t) {
            for (var i, n, r, o = /function\s+([_$a-zA-Z\xA0-\uFFFF][_$a-zA-Z0-9\xA0-\uFFFF]*)?\s*\(/i,
            s = [], c = {},
            u = !1, p = m.caller; p && !u; p = p.caller) if (p !== f && p !== x) {
                if (n = {
                    url: null,
                ...
                p.name ? n.func = p.name: (i = o.exec(p.toString())) && (n.func = i[1]), r = d(p)) {
                    n.url = r.url,
                    n.line = r.line,
                    n.func === UNKNOWN_FUNCTION && (n.func = a(n.url, n.line));
            ...
            return h(v, e.sourceURL || e.fileName, e.line || e.lineNumber, e.message || e.description),
            v
        }
        function f(e, t) {
            var i = null;
        ...
        b = e.linesOfContext,
        x = e.tracekitReport;
        return f.augmentStackTraceWithInitialElement = h,
        f.guessFunctionName = a,
        f.gatherContext = n,
        f.ofCaller = g,
        f
    }
    ...
    function _guessErrorClass(e) {
        ...
        i = "(unknown)";
        return t && (i = t[t.length - 1], e = e.replace((t[t.length - 2] || "") + i + ":", ""), e = e.replace(/(^[\s]+|[\s]+$)/g, "")),
        [i, e]
    }
    ...
    function _processPayload(e, t, i, a) {
        ...
        null, !1, !0), i.ignoreRateLimit && delete i.ignoreRateLimit, XHR.post(e, t, i,
        function(e, t) {
            return e ? a(e) : a(null, t)
        }), void 0)
    }
    function _rollbarWindowOnError(e, t, i) { ! i[4] && window._rollbarWrappedError && (i[4] = window._rollbarWrappedError, window._rollbarWrappedError = null),
        globalNotifier.uncaughtError.apply(globalNotifier, i),
        t && t.apply(window, i)
    }
    ...
    var setupCustomJSON = function(JSON) {
        ...
        function str(e, t) {
            ...
            case "object":
                ...
                if (rep && "object" == typeof rep) for (r = rep.length, i = 0; r > i; i += 1)"string" == typeof rep[i] && (a = rep[i], n = str(a, l), n && o.push(quote(a) + (gap ? ": ": ":") + n));
                else for (a in l) Object.prototype.hasOwnProperty.call(l, a) && (n = str(a, l), n && o.push(quote(a) + (gap ? ": ": ":") + n));
                return n = 0 === o.length ? "{}": gap ? "{\n" + gap + o.join(",\n" + gap) + "\n" + s + "}": "{" + o.join(",") + "}",
                gap = s,
                n
            }
        ...
        "function" != typeof JSON.stringify && (JSON.stringify = function(e, t, i) {
            var a;
            if (gap = "", indent = "", "number" == typeof i) for (a = 0; i > a; a += 1) indent += " ";
        ...
        "function" != typeof JSON.parse && (JSON.parse = function(text, reviver) {
            function walk(e, t) {
                var i, a, n = e[t];
                if (n && "object" == typeof n) for (i in n) Object.prototype.hasOwnProperty.call(n, i) && (a = walk(n, i), void 0 !== a ? n[i] = a: delete n[i]);
    ...
    Util = {
        merge: function() {
            var e, t, i, a, n, r, o = arguments[0] || {},
            s = 1,
            l = arguments.length,
            d = !0;
            for ("object" != typeof o && "function" != typeof o && (o = {}); l > s; s++) if (null !== (e = arguments[s])) for (t in e) e.hasOwnProperty(t) && (i = o[t], a = e[t], o !== a && (d && a && (a.constructor == Object || (n = a.constructor == Array)) ? (n ? (n = !1, r = []) : r = i && i.constructor == Object ? i: {},
            o[t] = Util.merge(r, a)) : void 0 !== a && (o[t] = a)));
            return o
        },
        copy: function(e) {
            var t;
            return "object" == typeof e && (e.constructor == Object ? t = {}: e.constructor == Array && (t = [])),
            Util.merge(t, e),
            t
        },
        parseUriOptions: {
        ...
        parseUri: function(e) {
            ...
            for (var t = Util.parseUriOptions,
            i = t.parser[t.strictMode ? "strict": "loose"].exec(e), a = {},
            n = 14; n--;) a[t.key[n]] = i[n] || "";
            return a[t.q.name] = {},
            a[t.key[12]].replace(t.q.parser,
            function(e, i, n) {
                i && (a[t.q.name][i] = n)
            }),
            a
        ...
        traverse: function(e, t) {
            ...
            o = [];
            if (r) if (e.constructor === Object) for (i in e) e.hasOwnProperty(i) && o.push(i);
            else if (e.constructor === Array) for (n = 0; n < e.length; ++n) o.push(n);
            for (n = 0; n < o.length; ++n) i = o[n],
            a = e[i],
            r = "object" == typeof a,
            e[i] = r ? null === a ? t(i, a) : a.constructor === Object ? Util.traverse(a, t) : a.constructor === Array ? Util.traverse(a, t) : t(i, a) : t(i, a);
            return e
        },
        redact: function(e) {
            return e = String(e),
                ...
                try {
                    var r = function() {
                        try {
                            ...
                            var t;
                            t = "object" == typeof e && e.stack ? e: new Error(e),
                            a(t)
                        }
                    };
                    n.open("POST", e, !0),
                    n.setRequestHeader && (n.setRequestHeader("Content-Type", "application/json"), n.setRequestHeader("X-Rollbar-Access-Token", t)),
    ...
    Notifier.prototype._getLogArgs = function(e) {
        for (var t, i, a, n, r, o, s, l = this.options.logLevel || Notifier.DEFAULT_LOG_LEVEL,
        d = 0; d < e.length; ++d) s = e[d],
        o = typeof s,
        "string" === o ? i = s: "function" === o ? r = _wrapNotifierFn(s, this) : s && "object" === o && ("Date" === s.constructor.name ? t = s: s instanceof Error || s.prototype === Error.prototype || s.hasOwnProperty("stack") ? a = s: n = s);
        return {
            level: l,
            message: i,
            err: a,
    ...
    Notifier.prototype._route = function(e) {
        ...
        i = /\/$/.test(t),
        a = /^\//.test(e);
        return i && a ? e = e.substring(1) : i || a || (e = "/" + e),
        t + e
    },
    Notifier.prototype._processShimQueue = function(e) {
        for (var t, i, a, n, r, o, s, l = {}; i = e.shift();) t = i.shim,
        a = i.method,
        n = i.args,
        r = t.parentShim,
        s = l[t.shimId],
        s || (r ? (o = l[r.shimId], s = new Notifier(o)) : s = this, l[t.shimId] = s),
        s[a] && "function" == typeof s[a] && s[a].apply(s, n)
    },
    ...
    Notifier.prototype._buildPayloadBodyTrace = function(e, t, i) {
        ...
        if (e && (o.exception.description = e || "uncaught exception"), t.stack) {
            var s, l, d, c, u, p, h, m;
            for (o.frames = [], h = 0; h < t.stack.length; ++h) s = t.stack[h],
            l = {
            ...
            d = c = u = null,
            p = s.context ? s.context.length: 0,
            p && (m = Math.floor(p / 2), c = s.context.slice(0, m), d = s.context[m], u = s.context.slice(m)),
            d && (l.code = d),
            (c || u) && (l.context = {},
            c && c.length && (l.context.pre = c), u && u.length && (l.context.post = u)),
            s.args && (l.args = s.args),
            o.frames.push(l);
    ...
    Notifier.prototype._scrub = function(e) {
        ...
        function i(e) {
            var i;
            if ("string" == typeof e) for (i = 0; i < s.length; ++i) e = e.replace(s[i], t);
            return e
        }
        function a(e, t) {
            var i;
            for (i = 0; i < o.length; ++i) if (o[i].test(e)) {
                t = Util.redact(t);
                break
            }
            return t
        ...
        return Util.traverse(e, n),
        e
    },
    Notifier.prototype._getScrubFieldRegexs = function(e) {
        for (var t, i = [], a = 0; a < e.length; ++a) t = "\\[?(%5[bB])?" + e[a] + "\\[?(%5[bB])?\\]?(%5[dD])?",
        i.push(new RegExp(t, "i"));
        return i
    },
    ...
    Notifier.prototype._urlIsWhitelisted = function(e) {
        ...
        try {
            ...
            for (s = t.length, r = i.frames.length, d = 0; r > d; d++) {
                ...
                for (c = 0; s > c; c++) if (o = t[c], l = new RegExp(o), l.test(n)) return ! 0
            }
        } catch(u) {
            return this.configure({
                hostWhiteList: null
            }),
            this.error("Error while reading your configuration's hostWhiteList option. Removing custom hostWhiteList.", u),
            !0
        }
        return ! 1
    },
    ...
    Notifier.prototype._enqueuePayload = function(e, t, i, a) {
        ...
        if (this._internalCheckIgnore(t, i, e)) return r(),
        void 0;
        try {
            if (this.options.checkIgnore && "function" == typeof this.options.checkIgnore && this.options.checkIgnore(t, i, e)) return r(),
            void 0
        } catch(o) {
            this.configure({
                checkIgnore: null
    ...
    Notifier.prototype._log = function(e, t, i, a, n, r, o) {
        ...
        o && (l.ignoreRateLimit = !0),
        this._enqueuePayload(l, r ? !0 : !1, [e, t, i, a], n)
    },
    ...
    Notifier.prototype.warn = Notifier._generateLogFn("warning"),
    ...
    Notifier.prototype.uncaughtError = _wrapNotifierFn(function(e, t, i, a, n, r) {
        if (r = r || null, n && n.stack) return this._log(this.options.uncaughtErrorLevel, e, n, r, null, !0),
        void 0;
        if (t && t.stack) return this._log(this.options.uncaughtErrorLevel, e, t, r, null, !0),
        void 0;
        var o = {
            url: t || "",
            line: i
        };
        o.func = TK.guessFunctionName(o.url, o.line),
        o.context = TK.gatherContext(o.url, o.line);
        var s = {
            mode: "onerror",
    ...
    Notifier.prototype.global = _wrapNotifierFn(function(e) {
        e = e || {},
        Util.merge(window._globalRollbarOptions, e),
        void 0 !== e.maxItems && (rateLimitCounter = 0),
        void 0 !== e.itemsPerMinute && (rateLimitPerMinCounter = 0)
    }),
    ...
    Notifier.prototype.scope = _wrapNotifierFn(function(e) {
        ...
        return Util.merge(t.options.payload, e),
        t
    }),
        ...
        if (!e._wrapped) {
            e._wrapped = function() {
                try {
                    ...
                    throw t.stack || (t._tkStackTrace = TK(t)),
                    t._rollbarContext = i(),
    ...
    Notifier.processPayloads = function(e) { (!payloadProcessorTimeout || e) && _payloadProcessorTimer(e)
    };
    ...
    globalNotifier.init = function(e) {
        if (this.configure(e), e.captureUncaught) {
            ...
            window[a] && window[a].prototype && _extendListenerPrototype(this, window[a].prototype)
        }
        Notifier.processPayloads()
    },
    module.exports = globalNotifier
}),
define("app", ["libs/core", "helpers/menu", "helpers/locale", "helpers/theme", "libs/rollbar"],
function(e, t, i, a, n) {
    webix.codebase = document.location.href.split("#")[0].replace("index.html", "") + "libs/webix/",
    !webix.env.touch && webix.ui.scrollSize && webix.CustomScroll && webix.CustomScroll.init(),
    webix.production && n.init({
...
webix.protoUI({
    ...
    defaults: {
        template: function(e) {
            ...
            e.value && (t += "<span class='webix_icon_count'>" + e.value + "</span>"),
            t += "</button>"
        },
        width: 33
    },
...
webix.type(webix.ui.tree, {
    ...
    icon: function(e) {
        for (var t = "",
        i = "",
        a = 1; a <= e.$level; a++) if (a == e.$level && e.$count) {
...
define("views/webix/menutree",
function() {}),
define("views/app", ["views/menus/search", "views/menus/mail", "views/menus/message", "views/menus/profile", "views/menus/sidebar", "views/webix/icon", "views/webix/menutree"],
function(e, t, i, a, n) {
    var r = {
        view: "toolbar",
        elements: [{
        ...
        },
        {
            ...
            template: function(e) {
                ...
                return t += "<img class='photo' src='assets/imgs/photos/" + e.id + ".png' /><span class='name'>" + e.name + "</span>",
                t += "<span class='webix_icon fa-angle-down'></span></div>"
            }
        },
        {},
        {
...
webix.protoUI({
    ...
    $init: function() {
        this.$ready.push(function() {
            ...
            if (e) for (var i = 0; i < e.length; i++) t.push("<div class='dhx_cal_tab" + (0 === i ? " dhx_cal_tab_first": "") + (i == e.length - 1 ? " dhx_cal_tab_last": "") + "' name='" + e[i] + "_tab' ></div>");
            t.push("</div><div class='dhx_cal_header'></div><div class='dhx_cal_data'></div></div>"),
    ...
    _render_once: function() {
        ...
        webix.require(["scheduler/dhtmlxscheduler.js"],
        function() {
            var e = this._scheduler = window.Scheduler ? Scheduler.getSchedulerInstance() : window.scheduler;
            this.config.init && this.config.init.call(this),
            e.init(this.$view.firstChild, this.config.date || new Date, this.config.mode || "week"),
            this.config.ready && this.config.ready.call(this)
        },
        this)
    }
},
webix.ui.view),
define("views/webix/scheduler",
function() {}),
...
define("views/modules/scheduler", ["views/webix/scheduler", "models/events"],
function(e, t) {
    var i = function() {
            ...
            rows: [{
                ...
                },
                {
                    ...
                    init: function() {
                        ...
                        scheduler.templates.event_class = function(e, t, i) {
                        ...
                        scheduler.templates.week_scale_date = e("%D, %W/%j"),
                        scheduler.templates.week_date = function(e, a) {
...
define("views/calendar", ["views/modules/scheduler"],
function(e) {
    var t = {
        type: "space",
        cols: [e]
    ...
    return {
        $ui: {
            ...
            template: function(e) {
                for (var t = null,
                i = e.items,
                a = "<div class='flex_tmp'>",
                n = 0; n < i.length; n++) t = i[n],
                a += "<div class='item " + t.css + "'>",
                a += "<div class='webix_icon icon fa-" + t.icon + "'></div>",
                a += "<div class='details'><div class='value'>" + t.value + "</div><div class='text'>" + t.text + "</div></div>",
                a += "<div class='footer'>View more <span class='webix_icon fa-angle-double-right'></span></div>",
                a += "</div>";
                return a += "</div>"
            },
            data: {
...
define("views/modules/visitors", ["models/visitors"],
function(e) {
    return {
        $ui: {
            type: "clean",
...
define("views/modules/chart_diff", [],
function() {
    function e(e, t) {
        for (var i = 0,
        a = 0; a < t.length; a++) i += parseFloat(t[a].sales) || 0,
        i += parseFloat(t[a].sales2) || 0;
...
define("views/modules/taskschart", [],
function() {
    var e = {
        view: "chart",
        type: "barH",
...
define("views/modules/diffchart", [],
function() {
    var e = {
        gravity: 3,
        type: "clean",
...
define("views/charts", ["views/modules/dashline", "views/modules/visitors", "views/modules/orders", "views/modules/chart_diff", "views/modules/revenue", "views/modules/taskschart", "views/modules/diffchart"],
    ...
    t = {
        ...
        type: {
            ...
            template: function(e) {
                ...
                i = "<img class='photo' src='assets/imgs/photos/" + e.personId + ".png' />";
                return i += "<div class='text'><div class='name'>" + e.name + "<div class='time'>" + e.time + "</div></div>",
                i += t + "</div>"
            }
        },
        data: [{
...
webix.protoUI({
    ...
    render: function() {
        if ("undefined" == typeof google || "undefined" == typeof google.maps) {
            ...
            t.src = "//maps.google.com/maps/api/js?sensor=false&callback=" + e,
    ...
    center_setter: function(e) {
        return this.map && this.map.setCenter(new google.maps.LatLng(e[0], e[1])),
        e
    },
    mapType_setter: function(e) {
        return this.map && this.map.setMapTypeId(google.maps.MapTypeId[e]),
        e
    },
    zoom_setter: function(e) {
        return this.map && this.map.setZoom(e),
        e
    },
    defaults: {
        zoom: 5,
...
webix.ui.view),
define("views/webix/googlemap",
function() {}),
define("views/modules/map", ["views/webix/googlemap"],
function() {
    var e = {
        rows: [{
...
define("views/dashboard", ["views/modules/dashline", "views/modules/visitors", "views/modules/orders", "views/modules/messages", "views/modules/revenue", "views/modules/tasks", "views/modules/map"],
function(e, t, i, a, n, r, o) {
    var s = {
        type: "clean",
        rows: [e, {
...
define("views/modules/data_rating", ["models/data_arrays"],
function(e) {
    var t = {
        view: "toolbar",
    ...
    i = {
        ...
        },
        {
            ...
            minWidth: 80,
            template: function(e) {
                for (var t = "<div class='rating_bar_element star" + e.rating + "'>",
                i = 1; 6 > i; i++) t += "<div title='" + i + "' class='rating_star star" + i + "' style='left:" + (16 * i - 16) + "px'></div>";
                return t + "</div>"
            }
        }],
        onClick: {
            rating_star: function(e, t) {
                this.getItem(t.row)[t.column] = (e.target || e.srcElement).getAttribute("title"),
                this.updateItem(t.row)
            }
        },
        autoheight: !0,
        scheme: {
...
define("views/modules/data_treetable", ["models/data_arrays"],
function(e) {
    var t = {
        view: "toolbar",
...
define("views/modules/data_progress", ["models/data_arrays"],
function(e) {
    var t = {
        view: "toolbar",
    ...
    i = {
        ...
        },
        {
            ...
            template: function(e) {
                ...
                return t += "<div title='" + (parseInt(100 * e.progress, 10) + "%") + "' class='" + i + "' style='width:" + (100 * e.progress + "%") + "'></div>",
                t + "</div>"
            }
        },
        {
...
define("views/modules/data_spans", ["models/data_arrays"],
function(e) {
    var t = {
        view: "toolbar",
...
define("views/modules/data_pager", ["models/orders"],
function(e) {
    var t = {
        view: "toolbar",
...
define("views/datatables", ["views/modules/data_rating", "views/modules/data_treetable", "views/modules/data_progress", "views/modules/data_spans", "views/modules/data_pager"],
function(e, t, i, a, n) {
    var r = {
        type: "space",
        rows: [{
...
define("views/webix/filetree",
function() {}),
define("views/modules/edittree", ["models/files", "views/webix/editable", "views/webix/filetree"],
function(e) {
    var t = {
        id: "fileTree",
        view: "edittree",
        ...
        on: {
            onAfterSelect: function(e) {
                ...
                for (var t = []; e;) t.push(this.getItem(e).value + "/"),
                e = this.getParentId(e);
                t.reverse(),
                $$("path").setValue(t.join(""))
            }
        }
    };
    return {
...
define("views/webix/fileview",
function() {}),
define("views/files", ["models/files", "views/modules/edittree", "views/webix/fileview"],
function(e, t) {
    var i = {
        type: "space",
        rows: [{
    ...
    return {
        ...
        $oninit: function() {
            ...
            $$("filesView").attachEvent("onDestruct",
            function() {
...
define("views/modules/form_user", [],
function() {
    var e = {
        type: "clean",
        rows: [{
...
define("views/modules/form_project", [],
function() {
    var e = {
        type: "clean",
        rows: [{
...
define("views/modules/form_event", [],
function() {
    var e = {
        type: "clean",
        rows: [{
...
define("views/modules/form_style", [],
function() {
    var e = {
        type: "clean",
        rows: [{
...
define("views/forms", ["views/modules/form_user", "views/modules/form_project", "views/modules/form_event", "views/modules/form_style"],
function(e, t, i, a) {
    var n = {
        type: "space",
        cols: [{
...
webix.protoUI({
    ...
    _init_ckeditor_once: function() {
        ...
        this.$view.innerHTML = "<textarea id='" + e + "'>" + this.config.value + "</textarea>",
        ...
        webix.require("ckeditor/ckeditor.js",
        function() {
    ...
    setValue: function(e) {
        this.config.value = e,
        this._3rd_editor ? this._3rd_editor.setData(e) : webix.delay(function() {
            this.setValue(e)
        },
        this, [], 100)
    },
    ...
    focus: function() {
        this._focus_await = !0,
        this._3rd_editor && this._3rd_editor.focus()
    },
    getEditor: function() {
...
webix.ui.view),
define("views/webix/ckeditor",
function() {}),
define("views/modules/editor", ["views/webix/ckeditor"],
function() {
    var e = {
        view: "form",
        id: "mainView",
...
define("views/modules/product_meta", [],
function() {
    return {
        $ui: {
            view: "form",
...
define("views/modules/product_search", ["models/products"],
function(e) {
    return {
        $ui: {
            rows: [{
...
define("views/modules/product_upload", [],
function() {
    return {
        $ui: {
            id: "imagesView",
...
define("views/modules/topsales", ["models/topsales"],
function(e) {
    var t = {
        view: "chart",
        borderless: !0,
        ...
        color: function(e) {
            var t = "#a693eb";
            return 2 == e.productId ? t = "#63b4ea": 3 == e.productId ? t = "#f19b60": 4 == e.productId && (t = "#49cd81"),
            t
        },
        yAxis: {
            template: function(e) {
...
define("views/orders", ["views/forms/order", "views/menus/export", "models/orders"],
function(e, t, i) {
    var a = [{
        view: "button",
        type: "iconButton",
...
define("views/product_edit", ["views/modules/product_search", "views/modules/editor", "views/modules/product_upload", "views/modules/product_meta"],
function(e, t, i, a) {
    var n = {
        type: "space",
        rows: [{
...
define("views/products", ["views/modules/editor", "views/modules/topsales", "models/products"],
function(e, t, i) {
    var a = {
        id: "productsData",
        view: "datatable",
                ...
                webix.confirm({
                    ...
                    callback: function(e) {
                        if (e) {
                            ...
                            i.status = "0",
                            i.statusName = "Deleted",
                            webix.$$("productsData").refresh(t)
                        }
                    }
                })
            }
